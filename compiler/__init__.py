...
# Passes
from .passes import DCEPass, LoopUnrollPass, CSEPass, SimplifyPass, HIRToLIRPass, PhiEliminationPass, LIRToVLIWPass
...
__all__ = [
    ...
    # Passes
    'DCEPass', 'LoopUnrollPass', 'CSEPass', 'SimplifyPass', 'HIRToLIRPass', 'PhiEliminationPass', 'LIRToVLIWPass',
]
